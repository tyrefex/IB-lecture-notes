...
Define the \emph{acceptance region}\index{acceptance region} $A$ of a test to be the complement of the critical region. Let $X \sim f_x(:\mid \theta)$, for some $\theta \in \Theta$.
...
\begin{theorem}[Gauss-Markov]\index{Gauss-Markov theorem}

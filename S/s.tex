...
\begin{exbox}
	...
	\[
		\mathbb{P}\biggl( \hat p - z \frac{\sqrt{\hat p (1 - \hat p)}}{\sqrt n} \leq p \hat p + z \frac{\sqrt{\hat p (1 - \hat p)}}{\sqrt n} \biggr) \approx 0.95
	.\]
...
This does not mean for specific $X_1 = x_1$, $X_2 = x_2$ the value $\theta$ lies in $(\min(x_1,x_2), \max(x_1,x_2))$ with probability $\frac{1}{2}$: consider when $|x_1 - x_2| > \frac{1}{2}$.
